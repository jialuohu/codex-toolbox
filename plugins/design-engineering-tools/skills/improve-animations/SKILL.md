...
[the audit bar](references/audit.md) for precise checks.
...
never write plan files or dispatch executors. Saving a plan requires explicit
authorization from the user. After explicit authorization to implement, route
