...
- Use built-in Codex web search for public discovery, Defuddle for straightforward public pages, and Firecrawl only for bounded Scrape when a selected public page needs difficult or dynamic clean-Markdown extraction.
